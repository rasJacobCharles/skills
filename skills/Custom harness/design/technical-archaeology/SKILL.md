...
# Custom Harness Technical Archaeology Skill

This skill is designed for custom LLM orchestration frameworks and harnesses. It guides the LLM to scan a repository, detect gaps in architectural documentation, and lead an interactive discovery dialogue with the developer to compile a standardized Technical Design Document (TDD).
