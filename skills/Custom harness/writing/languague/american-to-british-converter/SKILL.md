...
# Custom Harness American to British English Converter Skill

This skill is designed for custom LLM orchestration frameworks and harnesses. It converts text, individual files, or entire directories from American English (US) spelling and vocabulary to British English (UK) spelling and vocabulary.
