...
# Custom Harness Research Skill

This skill is designed for custom LLM orchestration frameworks and harnesses. It guides the LLM to execute structured user/idea research, collect transcripts, and organize findings into structured Obsidian notes.
