...
1. **Check for changes and load/setup configuration**:
   ...
   - If not found, use the `ask_question` tool to interactively prompt the user: "Would you like to automatically extract ticket IDs from your git branch names to use as the commit scope?"
...
Antigravity: I've analysed your changes. Here's what I found:
...
Antigravity: [Commits the changes with the approved message]
```
