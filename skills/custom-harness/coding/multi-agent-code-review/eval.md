...
This evaluation verifies the execution of the Multi-Agent Code Review skill. It loads fixtures from the central `evals/fixtures/multi-agent-code-review.json` file and evaluates agent and loop behaviours against the rubric `evals/rubrics/multi-agent-code-review.md`.
